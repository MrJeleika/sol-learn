...
export function Header() {
  ...
  return (
    <>
      ...
      <header className="bg-background backdrop-blur-md border-b border-border flex justify-between px-8 py-4 items-center fixed top-0 left-0 right-0 z-40">
        <div className="flex items-center gap-4">
          <div className="flex items-center gap-4">
            <svg
              ...
              className="w-16 h-16 fill-foreground shrink-0"
            >
            ...
            <div className="flex gap-1 whitespace-nowrap overflow-hidden">
              {'SOL LEARN'.split('').map((char, i) => (
                <span key={i} className="text-3xl font-bold text-foreground kode-mono-bold inline-block">
                  {char === ' ' ? '\u00A0' : char}
                </span>
              ))}
            </div>

...
export function Header() {
  ...
  return (
    <>
      ...
      <header className="bg-background backdrop-blur-md border-b border-border flex justify-center sm:justify-between xl:px-12 px-4 sm:px-6 py-4 items-center z-40">

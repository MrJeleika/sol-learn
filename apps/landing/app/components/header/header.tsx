...
export function Header() {
  ...
  return (
    <>
      ...
      <header className="bg-background backdrop-blur-md border-b border-border flex justify-center sm:justify-between xl:px-20 px-4 sm:px-10 py-4 items-center z-40">
        <div className="flex items-center gap-4">
          <div className="flex items-center gap-4">
            <svg
              ...
              className="sm:w-16 w-12 sm:h-16 h-12 fill-foreground shrink-0"
            >
            ...
            <div className="flex gap-1 whitespace-nowrap overflow-hidden">
              {'SOL LEARN'.split('').map((char, i) => (
                <span key={i} className="sm:text-3xl text-xl font-bold text-foreground kode-mono-bold inline-block">
                  {char === ' ' ? '\u00A0' : char}
                </span>
              ))}
            </div>

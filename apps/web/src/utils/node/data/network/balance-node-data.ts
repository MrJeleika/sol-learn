...
export const balanceNodeConfig = {
  ...
  handles: [
    ...
    { position: Position.Right, type: 'source', dataField: 'balance', label: 'Balance', dataType: 'number' },
    { position: Position.Right, type: 'source', dataField: 'balanceRaw', label: 'Balance Raw', dataType: 'number' },
  ],
